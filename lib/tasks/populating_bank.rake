namespace :populating_bank do
  Faker::Config.locale = 'pt-BR'
  desc "TODO"
  task populating_pet: :environment do
    p "Creating dogs in the bank ..."
    Breed.destroy_all
    breeds = [
      "Affenpinscher",
      "Afghan hound",
    ...
    1000.times do
      Pet.create(
        ...
        gender: rand(0..1),
        castrated: ['sim',"nao"].sample,
        born_at: Faker::Date.between(1.day.ago, 17.year.ago),
        client_name: Faker::Name.name,
        phone: Faker::PhoneNumber.phone_number,
        last_visit: Faker::Date.between(1.day.ago, 3.year.ago)
      )
    end
    p "Create dogs...ok"
    p "Reindex Dog..."
    Pet.reindex
    p "Reindex Dog...ok"
    p "Creating dogs in the bank ...ok"
  end
